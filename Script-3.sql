...
drop table vehicle_type_code;
create table vehicle_type_code(
id int,
vehicle_type varchar(11) not null,
primary key(id)
);

insert into vehicle_type_code values(2, "2 wheeler");
insert into vehicle_type_code values(4, "4 wheeler");

select * from vehicle_type_code ;
...
foreign key(vehicle_type) references vehicle_type_code(id)
);

select * from parking_history;


insert into parking_history(entry_date, driver_name, driver_ph_no, vehicle_type, license_plate_no, slot_no, entry_time, exit_time) values("29-03-2023","Chandan Singh",7762435910,4,"MH31AC3069","B-01","10:10:20","12:10:29");
insert into parking_history(entry_date, driver_name, driver_ph_no, vehicle_type, license_plate_no, slot_no, entry_time, exit_time) values("29-03-2023","Monika Hamand",7762335910,4,"MH31AC4423","B-02","10:15:10",null);
insert into parking_history(entry_date, driver_name, driver_ph_no, vehicle_type, license_plate_no, slot_no, entry_time, exit_time) values("29-03-2023","Keerthi Jajula",7862435910,2,"MH40AY7845","A-01","10:16:09",null);
insert into parking_history(entry_date, driver_name, driver_ph_no, vehicle_type, license_plate_no, slot_no, entry_time, exit_time) values("29-03-2023","Kamaldeep Singh",7762035910,4,"MH40FY2022","B-03","11:18:39",null);
insert into parking_history(entry_date, driver_name, driver_ph_no, vehicle_type, license_plate_no, slot_no, entry_time, exit_time) values("29-03-2023","Harpreet Singh",7762430910,4,"MH31BQ9081","B-04","11:20:23",null);
insert into parking_history(entry_date, driver_name, driver_ph_no, vehicle_type, license_plate_no, slot_no, entry_time, exit_time) values("29-03-2023","Jaspreet Singh",7762430810,2,"MH40BE9082","A-02","11:23:24",null);
insert into parking_history(entry_date, driver_name, driver_ph_no, vehicle_type, license_plate_no, slot_no, entry_time, exit_time) values("29-03-2023","Seema Patrakar",7762430510,2,"MH40AC9091","A-03","11:25:10",null);
insert into parking_history(entry_date, driver_name, driver_ph_no, vehicle_type, license_plate_no, slot_no, entry_time, exit_time) values("29-03-2023","Anamika Ahuja",7762430310,4,"AP28BY2389","B-05","12:10:06",null);
insert into parking_history(entry_date, driver_name, driver_ph_no, vehicle_type, license_plate_no, slot_no, entry_time, exit_time) values("29-03-2023","Maria Mathew",7762430210,4,"AP28ET8080","B-01","12:15:28",null);
...
select parking_history.driver_name, parking_history.driver_ph_no, vehicle_type_code.vehicle_type  , parking_history.license_plate_no, parking_history.slot_no, parking_history.entry_time from parking_history left join vehicle_type_code on parking_history.vehicle_type = vehicle_type_code.id where exit_time is null order by parking_history.id desc;
...
insert into invoice(inv_date, parking_id, amount_paid, payment_method)values("29-03-2023",1,20,"cash");
-- select 
...
select parking_history.entry_date, parking_history.driver_name, parking_history.driver_ph_no, vehicle_type_code.vehicle_type, parking_history.license_plate_no, parking_history.slot_no, parking_history.entry_time, parking_history.exit_time, invoice.amount_paid  from parking_history left join vehicle_type_code on parking_history.vehicle_type = vehicle_type_code.id left join invoice on parking_history.id  = invoice.parking_id order by parking_history.id desc;
