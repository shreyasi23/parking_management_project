...
//        List occupiedSlots = nativeQuery.list();
        SQLQuery query = session.createSQLQuery("select driver_name, driver_ph_no, vehicle_type, license_plate_no, slot_no, entry_time from parking_history where exit_time is null");
