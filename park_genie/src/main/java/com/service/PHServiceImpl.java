...
//        SQLQuery query = session.createSQLQuery("select driver_name, driver_ph_no, vehicle_type, license_plate_no, slot_no, entry_time from parking_history where exit_time is null order by id desc");
        SQLQuery query = session.createSQLQuery("select parking_history.driver_name, parking_history.driver_ph_no, vehicle_type_code.vehicle_type  , parking_history.license_plate_no, parking_history.slot_no, parking_history.entry_time from parking_history left join vehicle_type_code on parking_history.vehicle_type = vehicle_type_code.id where exit_time is null order by parking_history.id desc");
...
//        SQLQuery query =session.createSQLQuery("select parking_history.entry_date, parking_history.driver_name, parking_history.driver_ph_no, parking_history.vehicle_type, parking_history.license_plate_no, parking_history.slot_no, parking_history.entry_time, parking_history.exit_time, invoice.amount_paid  from parking_history left join invoice on parking_history.id=invoice.parking_id order by parking_history.id desc");
        SQLQuery query =session.createSQLQuery("select parking_history.entry_date, parking_history.driver_name, parking_history.driver_ph_no, vehicle_type_code.vehicle_type, parking_history.license_plate_no, parking_history.slot_no, parking_history.entry_time, parking_history.exit_time, invoice.amount_paid  from parking_history left join vehicle_type_code on parking_history.vehicle_type = vehicle_type_code.id left join invoice on parking_history.id  = invoice.parking_id order by parking_history.id desc");
